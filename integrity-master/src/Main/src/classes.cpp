...
Parameters::Parameters()
{
	...
	min_cluster_size= 10; //min # of points of each cluster. If less than this -> remove cluster
	min_plane_size= 100; // min # of points of each plane. If less than this -> do not extract plane
	min_density= 500; // min density of points of each cluster. If less dense than this -> remove cluster
	...
	min_cylinder_size= 10; // extract cylinders with at least this # of points
	min_association_distance= 1.5; //2 a cylinder is associated to a landmark in the map if is closer than this distance
