...
Parameters::Parameters()
{
	...
	zlim= -0.1; //0 points lower than 0.5m from the LIDAR height are removed (remove the ground points)
	...
	min_association_distance= 2.5; //2 a cylinder is associated to a landmark in the map if is closer than this distance
